...
const TaskModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'urgency': PropertySchema(
      ...
      name: r'urgency',
      type: IsarType.byte,
      enumMap: _TaskModelurgencyEnumValueMap,
    )
  },
...
void _taskModelSerialize(
  ...
  writer.writeByte(offsets[5], object.urgency.index);
}
...
TaskModel _taskModelDeserialize(
  ...
  object.urgency =
      _TaskModelurgencyValueEnumMap[reader.readByteOrNull(offsets[5])] ??
          TaskUrgency.urgent;
  return object;
}
...
P _taskModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 5:
      return (_TaskModelurgencyValueEnumMap[reader.readByteOrNull(offset)] ??
          TaskUrgency.urgent) as P;
    default:
      throw IsarError('Unknown property with id $propertyId');
  }
}

const _TaskModelurgencyEnumValueMap = {
  'urgent': 0,
  'normal': 1,
  'canWait': 2,
};
const _TaskModelurgencyValueEnumMap = {
  0: TaskUrgency.urgent,
  1: TaskUrgency.normal,
  2: TaskUrgency.canWait,
};
...
extension TaskModelQueryWhereSort
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhere> anyIsCompleted() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension TaskModelQueryWhere
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> isCompletedEqualTo(
      bool isCompleted) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> isCompletedNotEqualTo(
      bool isCompleted) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension TaskModelQueryFilter
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> urgencyEqualTo(
      TaskUrgency value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'urgency',
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> urgencyGreaterThan(
    TaskUrgency value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> urgencyLessThan(
    TaskUrgency value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> urgencyBetween(
    TaskUrgency lower,
    TaskUrgency upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskModelQuerySortBy on QueryBuilder<TaskModel, TaskModel, QSortBy> {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByUrgency() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'urgency', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByUrgencyDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQuerySortThenBy
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByUrgency() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'urgency', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByUrgencyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'urgency', Sort.desc);
    });
  }
...
extension TaskModelQueryWhereDistinct
  ...
  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctByUrgency() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQueryProperty
  ...
  QueryBuilder<TaskModel, TaskUrgency, QQueryOperations> urgencyProperty() {
    return QueryBuilder.apply(this, (query) {
